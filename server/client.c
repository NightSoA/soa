...
#ifdef MR
int target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); // 92.222.73.232
int update_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); // 92.222.73.232
int base_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); // 92.222.73.232
#endif
#ifdef DB
#define tmp (173<<24)+(214<<16)+(171<<8)+213;
...
#endif
#ifdef US
int target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
int update_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
int base_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
#endif
char username[40];
char password[16];
int zsinit;
...
void sv_server_old(unsigned char *buf)
{
        ...
        if (backup_server==0) {
                switch(target_server) {
                        case (92<<24)|(222<<16)|(73<<8)|(232<<0):       target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); break;
                        case (92<<24)|(222<<16)|(73<<8)|(233<<0):        target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); break;
                        case (92<<24)|(222<<16)|(73<<8)|(234<<0):        target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); break;
                        case (92<<24)|(222<<16)|(73<<8)|(235<<0):        target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); break;
                }
                ...
                switch(target_server) {
                        ...
                        case (92<<24)|(222<<16)|(73<<8)|(234<<0):        target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); break;
                        case (92<<24)|(222<<16)|(73<<8)|(235<<0):        target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); break;
                        case (92<<24)|(222<<16)|(73<<8)|(236<<0):        target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0); break;
                }
        }
}
