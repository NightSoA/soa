...
int updater(void)
{
        ...
        if (backup_server==0) {
                he=gethostbyname("update.shadowsofastonia.com");
                if (he) {
                        update_server=ntohl(*(unsigned long*)(*he->h_addr_list));
                } else {
                        update_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
                        fail("gethostbyname1 failed, using default");
                }
        } else if (backup_server==1) {
                he=gethostbyname("update2.shadowsofastonia.com");
                if (he) {
                        update_server=ntohl(*(unsigned long*)(*he->h_addr_list));
                } else {
                        update_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
                ...
                he=gethostbyname("update3.shadowsofastonia.com");
                if (he) {
                        update_server=ntohl(*(unsigned long*)(*he->h_addr_list));
                } else {
                        update_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
...
/* #ifndef DEVELOPER
        ...
        if (developer_server) {
                ...
                if (he) base_server=target_server=ntohl(*(unsigned long*)(*he->h_addr_list));
                        ...
                        base_server=target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
...
#ifndef DEVELOPER
        if (backup_server==0) {
                he=gethostbyname("login.shadowsofastonia.com");
                if (he) base_server=target_server=ntohl(*(unsigned long*)(*he->h_addr_list));
                else {
                        base_server=target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
                ...
                he=gethostbyname("login2.shadowsofastonia.com");
                if (he) base_server=target_server=ntohl(*(unsigned long*)(*he->h_addr_list));
                else {
                        base_server=target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
                ...
                he=gethostbyname("login3.shadowsofastonia.com");
                if (he) base_server=target_server=ntohl(*(unsigned long*)(*he->h_addr_list));
                else {
                        base_server=target_server=(92<<24)|(222<<16)|(73<<8)|(232<<0);
